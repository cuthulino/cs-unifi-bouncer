...
| `UNIFI_BLOCKED_PORTS_GROUP`   | Optional: name of an existing UniFi port group used as destination in generated firewall rules/policies. If unset, all destination ports are blocked | `none`                  |          ❌           |
