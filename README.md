...
| `UNIFI_BLOCKED_PORTS_LIST`    | Port group name to use for blocking. If empty (default), all ports are blocked. Create the port group in UniFi first (e.g., "Mail_Ports" for ports 25, 465, 587, 993). | `""`                    | ❌           |
